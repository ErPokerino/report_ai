...
display(format_summary_dict(summary_data, "Statistiche Dati"))
...
if 'field_name' in df.columns:
    ...
    display(format_table(field_stats_df, "Distribuzione e Statistiche per Campo (field_name)"))
...
# Prime righe
display(format_table(df.head(), "Prime righe del dataset"))
```
...
if recommendations:
    display(Markdown("### Raccomandazioni\n\n" + recommendations))
```
